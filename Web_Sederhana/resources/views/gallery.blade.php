{{-- @include('layout.header',['title' => 'Contact']) --}}
{{-- @include('layout.header',['title' => 'Data Gallery', 'dataA' => 'NilaiA','datab'=>'NilaiB']) --}}
...
@section('menuContact','active')
    ...
    <div class="container text-center mt-3 p-4 bg-white">
        ...
        <div class="row">
            ...
            <div class="col-4">
                <img src="https://source.unsplash.com/F8t2VGnI471/350x250" class="img-thumbnail img-fluid">
            </div>
        </div>
    </div>
    @endsection